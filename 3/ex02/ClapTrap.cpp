...
/*   Updated: 2025/01/14 05:36:36 by mmoussou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(void): _name("CL4P-TP"), _hit_points(10), _energy_points(10), _attack_points(0), _color(YELLOW)
{
	set_seed();
	...
	std::cout << this->_color << this->_name << ": " << welcome_sentence[std::rand() % 5] << RESET << std::endl;
}

ClapTrap::ClapTrap(std::string name): _name(name), _hit_points(10), _energy_points(10), _attack_points(0), _color(YELLOW)
{
	set_seed();
	std::string welcome_sentence[5] = { "You want me? To join you? I am SO excited. We will be best friends.", "My programmer always said two hands are better then one. But then he only gave me one. I wonder why?", "I wanna come, can I come? I promise I won't get in the way. Please?", "Battlebot go -- Oh that's me", "Did somebody call the Lovebot? No, oh well I'm here anyways" };

	std::cout << YELLOW << this->_name << ": " << welcome_sentence[std::rand() % 5] << RESET << std::endl;
}

ClapTrap::ClapTrap(std::string name, int hp, int ep, int ap, std::string color): _name(name), _hit_points(hp), _energy_points(ep), _attack_points(ap), _color(color)
{
	set_seed();
	std::string welcome_sentence[5] = { "You want me? To join you? I am SO excited. We will be best friends.", "My programmer always said two hands are better then one. But then he only gave me one. I wonder why?", "I wanna come, can I come? I promise I won't get in the way. Please?", "Battlebot go -- Oh that's me", "Did somebody call the Lovebot? No, oh well I'm here anyways" };
...
ClapTrap::ClapTrap(const ClapTrap &other): _name(other._name), _hit_points(10), _energy_points(10), _attack_points(0), _color(YELLOW)
{
	set_seed();
	std::string welcome_sentence[5] = { "You want me? To join you? I am SO excited. We will be best friends.", "My programmer always said two hands are better then one. But then he only gave me one. I wonder why?", "I wanna come, can I come? I promise I won't get in the way. Please?", "Battlebot go -- Oh that's me", "Did somebody call the Lovebot? No, oh well I'm here anyways" };
...
ClapTrap::ClapTrap(const ClapTrap &other, std::string color): _name(other._name), _hit_points(10), _energy_points(10), _attack_points(0), _color(color)
{
	set_seed();
	std::string welcome_sentence[5] = { "You want me? To join you? I am SO excited. We will be best friends.", "My programmer always said two hands are better then one. But then he only gave me one. I wonder why?", "I wanna come, can I come? I promise I won't get in the way. Please?", "Battlebot go -- Oh that's me", "Did somebody call the Lovebot? No, oh well I'm here anyways" };
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	std::cout << this->_color << this->_name << ": " << hit_sentence[std::rand() % 5] << RESET << std::endl;
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	...
	std::cout << this->_color << this->_name << ": " << "Good as new, I think. Am I leaking?" << RESET << std::endl;
}
